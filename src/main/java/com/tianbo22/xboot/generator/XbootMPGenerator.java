package com.tianbo22.xboot.generator;

import com.tianbo22.xboot.generator.bean.Entity;
...
import static com.tianbo22.xboot.generator.XbootGenerator.*;
...
public class XbootMPGenerator {
     ...
     * 建议仅需修改
     */
    private static final String author = "WangCH";
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "cn.tianbo22.xboot.modules.test.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "cn.tianbo22.xboot.modules.test.dao.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "cn.tianbo22.xboot.modules.test.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "cn.tianbo22.xboot.modules.test.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "cn.tianbo22.xboot.modules.test.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/cn/tianbo22/xboot/generator/template";
